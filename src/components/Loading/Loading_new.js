/**
 * Created by liuxiaoxiao1 on 2018/4/12.
 */
...
class Loading extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="infinite_scroll_loader" style={{visibility: this.props.isShow ? 'visible': 'hidden', 'textAlign': 'center'}} onClick={this._onClick.bind(this)} >
                <Icon className="loading-spinner__icon" type="loading" style={style} />
            </div>
        );
    }
}
